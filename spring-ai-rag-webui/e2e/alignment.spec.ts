...
test.describe('WebUI alignment policy', () => {
  test('uses start alignment for ordinary dashboard content', async ({ page }) => {
  ...
  test('keeps settings and API key management content start-aligned', async ({ page }) => {
    await page.setViewportSize({ width: 1440, height: 900 });
    await mockAllApiCalls(page);
  ...
  test('keeps the document upload zone centered without centering the table', async ({ page }) => {
    await page.setViewportSize({ width: 1440, height: 900 });
    await mockAllApiCalls(page);
  ...
  test('keeps file upload and preview placeholders centered while tree content starts at the edge', async ({ page }) => {
    await page.setViewportSize({ width: 1440, height: 900 });
    await mockAllApiCalls(page);
  ...
  test('keeps the alignment baseline on a narrow viewport', async ({ page }) => {

...
check_project_invariants() {
  ...
  [[ "$latest_migration" == "48" ]] || {
    echo "Expected latest Flyway migration V48, found V${latest_migration:-unknown}." >&2
    return 1
  }
  ...
  rg -q 'V1.?V48' AGENTS.md docs/developer-reference.md docs/developer-reference-zh-CN.md

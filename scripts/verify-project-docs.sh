...
check_project_invariants() {
  ...
  [[ "$latest_migration" == "43" ]] || {
    echo "Expected latest Flyway migration V43, found V${latest_migration:-unknown}." >&2
    return 1
  }
  ...
  rg -q 'V1.?V43' AGENTS.md docs/developer-reference.md docs/developer-reference-zh-CN.md

...
check_project_invariants() {
  ...
  [[ "$latest_migration" == "45" ]] || {
    echo "Expected latest Flyway migration V45, found V${latest_migration:-unknown}." >&2
    return 1
  }
  ...
  rg -q 'V1.?V45' AGENTS.md docs/developer-reference.md docs/developer-reference-zh-CN.md

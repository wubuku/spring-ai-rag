...
check_project_invariants() {
  ...
  [[ "$latest_migration" == "54" ]] || {
    echo "Expected latest Flyway migration V54, found V${latest_migration:-unknown}." >&2
    return 1
  }
  ...
  rg -q 'V1.?V54' AGENTS.md docs/developer-reference.md docs/developer-reference-zh-CN.md

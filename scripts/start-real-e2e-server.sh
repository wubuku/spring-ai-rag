...
_PRESERVE_SECURITY_ENABLED="${RAG_SECURITY_ENABLED-}"
_PRESERVE_ROOT_API_KEY="${RAG_ROOT_API_KEY-}"
_PRESERVE_CORS_ENABLED="${RAG_CORS_ENABLED-}"
_PRESERVE_CORS_ORIGIN_0="${RAG_CORS_ALLOWED_ORIGINS_0-}"
_PRESERVE_POSTGRES_HOST="${POSTGRES_HOST-}"
_PRESERVE_POSTGRES_PORT="${POSTGRES_PORT-}"
_PRESERVE_POSTGRES_DATABASE="${POSTGRES_DATABASE-}"
_PRESERVE_POSTGRES_USER="${POSTGRES_USER-}"
_PRESERVE_POSTGRES_PASSWORD="${POSTGRES_PASSWORD-}"
...
[[ -n "${_PRESERVE_SECURITY_ENABLED}" ]] && export RAG_SECURITY_ENABLED="${_PRESERVE_SECURITY_ENABLED}"
[[ -n "${_PRESERVE_ROOT_API_KEY}" ]] && export RAG_ROOT_API_KEY="${_PRESERVE_ROOT_API_KEY}"
[[ -n "${_PRESERVE_CORS_ENABLED}" ]] && export RAG_CORS_ENABLED="${_PRESERVE_CORS_ENABLED}"
[[ -n "${_PRESERVE_CORS_ORIGIN_0}" ]] && export RAG_CORS_ALLOWED_ORIGINS_0="${_PRESERVE_CORS_ORIGIN_0}"
[[ -n "${_PRESERVE_POSTGRES_HOST}" ]] && export POSTGRES_HOST="${_PRESERVE_POSTGRES_HOST}"
[[ -n "${_PRESERVE_POSTGRES_PORT}" ]] && export POSTGRES_PORT="${_PRESERVE_POSTGRES_PORT}"
[[ -n "${_PRESERVE_POSTGRES_DATABASE}" ]] && export POSTGRES_DATABASE="${_PRESERVE_POSTGRES_DATABASE}"
[[ -n "${_PRESERVE_POSTGRES_USER}" ]] && export POSTGRES_USER="${_PRESERVE_POSTGRES_USER}"
[[ -n "${_PRESERVE_POSTGRES_PASSWORD}" ]] && export POSTGRES_PASSWORD="${_PRESERVE_POSTGRES_PASSWORD}"

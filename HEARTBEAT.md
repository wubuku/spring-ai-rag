...
- 2026-04-23 19:23 - ✅ WebUI 常规巡检(cron):npm test 148 ✅(23 test files,148 vitest 全通过)/ npm run build ✅(99.62KB index gzipped,34 chunks)/ E2E 12/12 ✅(Dashboard/Documents/Collections/Chat+Real Chat/Search+Results/Metrics/Alerts/Settings/Navigation/Backend Health/SPA Routing);dist 已同步到 static/webui/;后端服务 8081 UP(health=UP,database=UP,pgvector=UP);git 工作区干净(无变更);WebUI 项目处于生产级成熟状态
  > - 2026-04-23 23:18 - ✅ 后端 i18n:SearchCapabilitiesTest 16个中文 @DisplayName → 英文(class+15 methods);inline Chinese comments → English;class Javadoc → English;保留 jieba/zh/trgm 术语;31 个 Chinese @DisplayName 仍待处理(FulltextSearchProviderFactoryTest 14/HybridRetrieverServiceBenchmarkTest 13/DomainExtensionPipelineIntegrationTest 2/DomainExtensionRegistryTest 1/PdfImportServiceTest 1);mvn test ✅(BUILD SUCCESS);commit 2105aaf 已推送

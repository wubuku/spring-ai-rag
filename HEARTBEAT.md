...
> - 2026-04-23 19:17 - ✅ 后端 i18n:GeneralRagAutoConfigurationBeanTest 23个+DocumentVersionServiceTest 19个=42个中文@DisplayName→英文+class Javadoc/inline comments→英文;mvn test ✅(BUILD SUCCESS);commit 94b9737 已推送;剩余约39个中文@DisplayName(~3测试文件待处理:RateLimitFilterPerUserTest 18/SearchCapabilitiesTest 17/FulltextSearchProviderFactoryTest 15 等)

> - 2026-04-23 13:26 - ✅ 后端 i18n:EvaluationControllerTest+RagSearchControllerTest @DisplayName 英文化--12+10=22个中文 @DisplayName →英文;section comments 英文化;保留中文测试数据字符串;mvn test ✅(BUILD SUCCESS);commit cbbbaa5 已推送;剩余约240个中文@DisplayName待翻译(HybridRetrieverServiceTest 35/DocumentEmbedServiceTest 29/RateLimitFilterTest 26/RequestTraceFilterTest 25等)

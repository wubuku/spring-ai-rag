...
> 对应历史规划：[2026-08-21_EXTERNAL_CLIENT_INTEGRATION_BOUNDARY_PLAN.md](2026-08-21_EXTERNAL_CLIENT_INTEGRATION_BOUNDARY_PLAN.md)
>
...
- 明确 RAG 只保存 allow-list 检索投影，私有附件和内部协议字段保留在客户端。
...
- 双 Collection、凭据轮换、客户端 DTO 清洗和重启恢复测试。
